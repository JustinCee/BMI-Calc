...
header = Label(root, text='BODY MASS INDEX CALCULATOR', bg='white', fg='blue')
header.place(x=200, y=20)

frame = Frame(root, width=500, height=200, relief='raised', bg='white')
frame.place(relx=0.15, rely=0.1)
# Below is the placement of the labels and the boxes
weight = Label(frame, text="Weight(kg):", bg='white', fg='blue')
weight.place(relx=0.1, rely=0.1)
weight_entry = Entry(frame)
weight_entry.place(relx=0.4, rely=0.1)

height = Label(frame, text="Height(cm):", bg='white', fg='blue')
